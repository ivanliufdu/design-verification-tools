...
syn keyword systemverilogStatement   and assert assign assume automatic before 
...
syn keyword systemverilogStatement   defparam design disable dist do edge else begin end
